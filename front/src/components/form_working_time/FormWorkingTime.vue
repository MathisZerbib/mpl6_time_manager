<template>
  <form v-on:submit.prevent="onSubmit">
    <div class="card rounded shadow">
      ...
      <div class="card-body">
        <div
          class=" d-flex main-layout  flex-lg-row flex-sm-column flex-md-column justify-content-around flex-column my-3 text-center">
      ...
      <button type="submit" class="btn btn-primary btn btn-primary my-3 w-50 m-auto"
        @click="createWokingTime()">Submit</button>
    </div>
  </form>
