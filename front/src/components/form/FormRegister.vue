<template>
      ...
      <div class="row">
        ...
        <div class="col-6 form-section">
          <div class="login-wrapper">
            ...
            <p class="login-wrapper-footer-text">Vous avez déjà un compte ? &nbsp;<a href="/login" class="text-reset">Connectez-vous ici</a></p>
          </div>
        </div>
      </div>
    </div>
  ...
  .intro-section {
    background-image: url("./src/assets/img/gotham.jpg");
