defmodule Api.Accounts do
  ...
  #   query = from u in User, where: u.email and u.username == ^email
  ...
  # def authenticate_user(email, password_hash) do
  #   with {:ok, user} <- get_by_email(email) do
  #     case validate_password(password_hash, user.password_hash) do
  ...
  # defp validate_password(password_hash, encrypted_password) do
  #   Bcrypt.verify_pass(password_hash, encrypted_password)
  # end
